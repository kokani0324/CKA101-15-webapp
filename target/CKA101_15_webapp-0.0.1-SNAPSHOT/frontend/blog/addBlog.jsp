				...
				<div>
					...
					<select id="blog_type_id" name="blog_type_id" required>
						...
						for (BlogTypeVO blogTypeVO : blogTypeList) {
							if (Integer.valueOf(1).equals(blogTypeVO.getBlogTypeId())) {
								continue;
							}
			...
			<div>
				...
				<select id="blog_status" name="blog_status" required>
					<option value="VISIBLE"
						<%=blogVO.getBlogStatus() == null || "VISIBLE".equals(String.valueOf(blogVO.getBlogStatus())) ? "selected" : ""%>>VISIBLE</option>
					<option value="HIDDEN"
						<%="HIDDEN".equals(String.valueOf(blogVO.getBlogStatus())) ? "selected" : ""%>>HIDDEN</option>
				</select>
			</div>
