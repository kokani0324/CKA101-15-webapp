...
<main>
    ...
    <div class="toolbar">
        ...
        <a class="btn secondary" href="${pageContext.request.contextPath}/blog/blog.do?action=getAll">查看全部 Blog</a>
        <a class="btn secondary" href="${pageContext.request.contextPath}/farmer/blog/addFarmDiary.jsp">新增農場日誌</a>
    </div>
