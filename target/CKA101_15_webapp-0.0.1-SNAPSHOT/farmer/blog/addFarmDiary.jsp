...
<body>
<main>
    <p><a href="${pageContext.request.contextPath}/farmer/blog/MyBloglist.jsp">回我的農場日誌</a></p>
    <h1>新增農場日誌</h1>

    <form method="post" action="${pageContext.request.contextPath}/blog/blog.do">
        <input type="hidden" name="action" value="insert">
        <input type="hidden" name="source" value="farmer">
        <input type="hidden" name="blog_status" value="上架">
        ...
        <div class="grid">
            ...
            <div>
                ...
                <input id="user_id" type="number" name="user_id" value="${empty blogVO.userId ? 1 : blogVO.userId}" min="1" required>
            </div>
            <div>
                <label for="blog_type_id">日誌分類編號</label>
                <input id="blog_type_id" type="number" name="blog_type_id" value="${empty blogVO.blogTypeId ? 1 : blogVO.blogTypeId}" min="1" required>
            </div>
        </div>
